...
public class StringsCannotAdd {
	public static void main(String[]args) {
		...
		// 1) Make a main method that includes all the steps below…. 
			...
			String fourAsString = JOptionPane.showInputDialog("eneter a number 4 ");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
			String sixAsString = JOptionPane.showInputDialog("eneter a number 6 ");
			...
			String fiveAsString = JOptionPane.showInputDialog("eneter a number 5 ");
